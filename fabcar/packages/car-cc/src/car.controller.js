...
var CarController = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(mockData.map(function (car) { return car.save(); }))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CarController.prototype.query = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, car_model_1.Car.getOne(id)];
            });
        });
    };
    CarController.prototype.queryAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, car_model_1.Car.getAll()];
            });
        });
    };
    CarController.prototype.create = function (car) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, car.save()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CarController.prototype.changeOwner = function (id, owner) {
        return __awaiter(this, void 0, void 0, function () {
            var car;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, car_model_1.Car.getOne(id)];
                    case 1:
                        car = _a.sent();
                        car.owner = owner;
    ...
    __decorate([
        convector_core_controller_1.Invokable(),
        __param(0, convector_core_controller_1.Param(yup.string()))
    ...
    __decorate([
        convector_core_controller_1.Invokable(),
        __param(0, convector_core_controller_1.Param(car_model_1.Car))
    ], CarController.prototype, "create", null);
    __decorate([
        convector_core_controller_1.Invokable(),
        __param(0, convector_core_controller_1.Param(yup.string())),
        __param(1, convector_core_controller_1.Param(yup.string()))
